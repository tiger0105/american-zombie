...
namespace Polaris.GameData
{
	...
	{
		private List<Type> m_defaultData = new List<Type>() {typeof(GameProperty), typeof(WeaponData), typeof(ItemData), typeof(MissionData), typeof(PurchaseData), typeof(MonsterData), typeof(DailyBonusData) };
		...
		private void InitAsynData(Func<string, Type, Type, object> formatData, Action<int, int> progress, Action finished)
		{
			try
			{
				...
				{
					if (item.Namespace == "Polaris.GameData")
					{
