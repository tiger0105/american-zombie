...
public class GiantTentecular : ZombieBehaviour {
	...
	void UpdateState(){
		...
		else if (Vector3.Distance(target.position ,transform.position) > 13f)
		{
		...
		else if (Vector3.Distance(target.position ,transform.position) > 7f){
