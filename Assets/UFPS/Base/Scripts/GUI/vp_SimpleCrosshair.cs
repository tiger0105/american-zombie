...
public class vp_SimpleCrosshair : MonoBehaviour
{
	...
	void OnGUI()
	{
		...
		GUI.DrawTexture(new Rect((Screen.width * 0.5f) - (m_ImageCrosshair.width * 0.5f / 3),
			(Screen.height * 0.5f) - (m_ImageCrosshair.height * 0.5f / 3), m_ImageCrosshair.width / 3,
			m_ImageCrosshair.height / 3), m_ImageCrosshair);
