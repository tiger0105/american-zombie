...
public class vp_Bullet : MonoBehaviour
{
	...
	{
//		Debug.Log ("collider game name............." + m_Hit.collider.gameObject.name);
//		Debug.Log ("transform name............." + m_Hit.transform.name);
//		Debug.Log ("transform tag............." + m_Hit.transform.tag);
//		Debug.Log ("collider name............." + m_Hit.collider.name);
		...
		CombatObserver co = GameObject.FindWithTag ("CombatObserver").GetComponent<CombatObserver>();
		//co.SendMessage ("DoHookHit", m_Hit, SendMessageOptions.DontRequireReceiver);
		co.DoHookHit(m_Hit);
	}
