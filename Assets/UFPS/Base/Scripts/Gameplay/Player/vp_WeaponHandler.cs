...
public class vp_WeaponHandler : MonoBehaviour
{
    ...
    [HideInInspector] public int m_AxeUse = 20;
    [HideInInspector] public int m_BaseballBatUse = 20;
    ...
    protected virtual bool OnAttempt_SetNextWeapon()
	{
        ...
        if (i == 8)
        {
            GameObject.Find("RangeAttackCount").transform.localScale = Vector3.one;
            GameObject.Find("RangeAttackCount").GetComponentInChildren<Text>().text = m_AxeUse.ToString();
        }
        else if (i == 9)
        {
            GameObject.Find("RangeAttackCount").transform.localScale = Vector3.one;
            GameObject.Find("RangeAttackCount").GetComponentInChildren<Text>().text = m_BaseballBatUse.ToString();
        }
        else if (i == 10)
        {
            GameObject.Find("RangeAttackCount").transform.localScale = Vector3.one;
            GameObject.Find("RangeAttackCount").GetComponentInChildren<Text>().text = "Ꝏ";
        }
        else
            GameObject.Find("RangeAttackCount").transform.localScale = Vector3.zero;

        ZoomManager.Instance.Init ();
		return true;
