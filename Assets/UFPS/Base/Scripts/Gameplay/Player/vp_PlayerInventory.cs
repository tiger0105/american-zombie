	...
	protected override void DoAddUnitBank(vp_UnitBankType unitBankType, int id, int unitsLoaded)
	{
        ...
        switch (unitBankType.name)
        {
            ...
            case "Shotgun":
                ...
                break;
            case "Autorifle":
                matchedName = "M16 Carbine Assault Rifle";
                break;
            case "Grenadegun":
                matchedName = "Grenade Launcher";
                break;
            case "Superrifle":
                matchedName = "M4 Carbon Rifle";
                break;
            case "Crossbow":
                matchedName = "Military Crossbow";
                break;
            case "Blaster":
                matchedName = "Experimental Plasma Rifle";
                break;
			case "FlameThrower":
				matchedName = "FlameThrower";
				break;
			case "Axe":
                matchedName = "Tactical Axe";
                break;
            case "BaseBallBat":
                matchedName = "Baseball Bat";
                break;
            default:
                break;
        }

        if (GameManager.Instance.m_MissionWeapons.Contains(matchedName))
        {
